...
// 1) o código não funciona do jeito que é esperado porque assume que o input de números pelo prompt, reornará um número, quando na realidade, o prompt recebe apenas strings, ou seja, números chegam no formato string. 
